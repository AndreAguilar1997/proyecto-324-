...
insert into FlujoProceso values('F1','P10','P11','P','CompraCarnet','Caja');
insert into FlujoProceso values('F1','P11','P12','P','EntregaCarnet','Caja');
insert into FlujoProceso values('F1','P12','P13','P','SolicitaMateria','Alumno');
insert into FlujoProceso values('F1','P13','P14','P','ListaCarrera','Kardex');
insert into FlujoProceso values('F1','P14','P15','P','AveriguarMateria','Caja');
insert into FlujoProceso values('F1','p15', null,'p','AsistirClase','Alumno');
